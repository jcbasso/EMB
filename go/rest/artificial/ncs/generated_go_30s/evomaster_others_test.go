...
/**
 * This file was automatically generated by EvoMaster on 2024-03-13T11:49:41.412-03:00[America/Argentina/Buenos_Aires]
 *
...
func (suite *EvoMasterOthersTest) Test_1() {
	...
	method := http.MethodGet
	reqUrl := "http://" + suite.BaseUrlOfSut + "/api/gammq/0.9989808147679288/-860933.4205423864?EMextraParam123=_EM_13_XYZ_"
...
func (suite *EvoMasterOthersTest) Test_3() {
	...
	method := http.MethodGet
	reqUrl := "http://" + suite.BaseUrlOfSut + "/api/expint/-260399595/0.025279216257378057?EMextraParam123=_EM_41_XYZ_"
...
func (suite *EvoMasterOthersTest) Test_4() {
	...
	req.Header.Set("x-EMextraHeader123", "_EM_56_XYZ_")
	res_0, err := http.DefaultClient.Do(req)
	suite.NoError(err, "Request error must be nil")
	defer res_0.Body.Close()
