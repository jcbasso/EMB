...
/**
 * This file was automatically generated by EvoMaster on 2024-03-13T14:48:21.048-03:00[America/Argentina/Buenos_Aires]
 * 
...
func (suite *EvoMasterFaultsTest) Test_0_with500() {
    ...
    reqUrl := "http://" + suite.BaseUrlOfSut + "/api/fisher/-536870188/-15422/0.204"
    
    req, err := http.NewRequest(method, reqUrl, nil)
    suite.Nil(err, "Request creation error must be nil")
    
    req.Header.Set("x-EMextraHeader123", "_EM_39_XYZ_")
...
func (suite *EvoMasterFaultsTest) Test_1_with500() {
    ...
    method := http.MethodGet
    reqUrl := "http://" + suite.BaseUrlOfSut + "/api/gammq/8.988465674311579E307/9.831134331278288E307?EMextraParam123=_EM_744_XYZ_"
    
    req, err := http.NewRequest(method, reqUrl, nil)
    suite.Nil(err, "Request creation error must be nil")
    
    req.Header.Set("x-EMextraHeader123", "_EM_745_XYZ_")
    res_0, err := http.DefaultClient.Do(req)
    suite.NoError(err, "Request error must be nil")
    defer res_0.Body.Close()
