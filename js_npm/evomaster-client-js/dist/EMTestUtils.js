...
class EMTestUtils {
     ...
     */
    static resolveLocation(locationHeader, expectedTemplate) {
        if (!locationHeader) {
            return expectedTemplate;
        }
        let locationURI;
        try {
            locationURI = new urijs_1.default(locationHeader);
        ...
        const templateURI = new urijs_1.default(normalizedTemplate);
     ...
     */
    static isValidURIorEmpty(uri) {
        if (!uri) {
            return true;
        }
        try {
            new urijs_1.default(uri);
            /*
...
exports.default = EMTestUtils;
//# sourceMappingURL=EMTestUtils.js.map